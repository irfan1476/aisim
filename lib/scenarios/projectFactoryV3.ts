...
export const projectFactoryV3Pack: V3ScenarioPack = {
  ...
  evidence: [
    { id: 'PF-E01', title: 'Plant performance dashboard', sourceType: 'expert-calibrated synthetic', sourceStatus: 'provisional', claimStatus: 'supported for problem framing; insufficient for root-cause attribution', authorRole: 'operations performance office', version: '0.1', availableFrom: 'Q1', informs: ['maintenance', 'quality', 'energy', 'capacity'] },
    { id: 'PF-E02', title: 'Asset-data readiness assessment', sourceType: 'expert-calibrated synthetic', sourceStatus: 'provisional', claimStatus: 'supported for research and constrained pilot; insufficient for scale', authorRole: 'CIO/data owner with maintenance analyst', version: '0.1', availableFrom: 'Q1', informs: ['maintenance', 'energy', 'governance'] },
    { id: 'PF-E03', title: 'Value-stream and change-window map', sourceType: 'expert-calibrated synthetic', sourceStatus: 'provisional', claimStatus: 'supported for capacity constraints; local workflow requires validation', authorRole: 'plant transformation office', version: '0.1', availableFrom: 'Q1', informs: ['portfolio', 'capacity', 'workflow'] },
    { id: 'PF-E04', title: 'Workforce continuity and workflow brief', sourceType: 'expert-calibrated synthetic', sourceStatus: 'provisional', claimStatus: 'supported for training capacity; not a complete attitude account', authorRole: 'maintenance lead and HR partner', version: '0.1', availableFrom: 'Q1', informs: ['knowledge', 'maintenance', 'stakeholders'] },
    { id: 'PF-E05', title: 'OEM quality, traceability, and delivery brief', sourceType: 'expert-calibrated synthetic', sourceStatus: 'provisional', claimStatus: 'supported for traceability and containment constraints', authorRole: 'quality/OEM account lead', version: '0.1', availableFrom: 'Q1', informs: ['quality', 'supply', 'events'] },
    { id: 'PF-E06', title: 'Finance, programme capacity, and value-range brief', sourceType: 'expert-calibrated synthetic', sourceStatus: 'provisional', claimStatus: 'supported for capital and capacity; insufficient for monetary attribution', authorRole: 'CFO transformation office', version: '0.1', availableFrom: 'Q1', informs: ['budget', 'capacity', 'stakeholders'] },
    { id: 'PF-E07', title: 'Governance and accountable-use brief', sourceType: 'expert-calibrated synthetic', sourceStatus: 'provisional', claimStatus: 'supported for control boundaries; insufficient for local validity', authorRole: 'CIO/CISO/data owner', version: '0.1', availableFrom: 'Q1', informs: ['gates', 'ledger', 'controls'] },
  ],
  initiatives: [
    initiative('maintenance', 'Predictive maintenance for critical assets', 'Maintenance lead', ['PF-E01', 'PF-E02', 'PF-E03', 'PF-E04', 'PF-E07'], ['quality'], 'asset_data_readiness', { data_engineering: { research: 2, pilot: 2, scale: 3 }, plant_integration: { research: 1, pilot: 2, scale: 2 }, frontline_change: { pilot: 2, scale: 2 }, governance_assurance: { pilot: 1, scale: 2 } }),
  ...
  causalRules: [
    { id: 'CR-PF-01', evidenceIds: ['PF-E02', 'PF-E04'], metric: 'unplanned_downtime_share', effects: [{ metric: 'unplanned_downtime_share', delta: -1.6, unit: 'percentage points' }, { metric: 'technician_trust', delta: 2, unit: 'index points' }] },
    { id: 'CR-PF-02', evidenceIds: ['PF-E01', 'PF-E05'], metric: 'first_pass_yield', effects: [{ metric: 'first_pass_yield', delta: 1, unit: 'percentage points' }, { metric: 'escaped_defects_ppm', delta: -100, unit: 'PPM' }] },
    { id: 'CR-PF-03', evidenceIds: ['PF-E04', 'PF-E07'], metric: 'workforce_readiness', effects: [{ metric: 'workforce_readiness', delta: 5, unit: 'index points' }, { metric: 'technician_trust', delta: 3, unit: 'index points' }] },
  ],
  events: [{ id: 'EV-PF-01', trigger: 'quarter >= 4', triggerMetric: 'unplanned_downtime_share', triggerInitiative: 'maintenance', effects: [{ metric: 'schedule_adherence', delta: -3, unit: 'percentage points', sourceRuleId: 'ER-PF-01', sourceEvidenceIds: ['PF-E02', 'PF-E03', 'PF-E04'] }] }],
