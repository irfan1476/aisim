...
const initiatives: ScenarioInitiative[] = [
  { id: 'maintenance', name: 'Predictive Maintenance', desc: 'Predict component failures weeks in advance.', cost: 2.8, roi: 187, risk: 'MED', data: 4, human: 3, impact: 'Cuts downtime and extends asset life.', baseEffect: -6, primaryMetric: 'downtimePressure', effectUnit: 'index points', frameworkContribution: { peopleChange: 65, processWorkflow: 85, techData: 85, algorithmModel: 75 }, lifecycleProfile: { dataReadiness: 78, evaluation: { criteria: [{ id: 'downtime-signal', label: 'Reduce unplanned downtime pressure', metric: 'downtimePressure', threshold: -2, direction: 'lower-is-better', kind: 'outcome' }, { id: 'pilot-readiness', label: 'Demonstrate a usable technician workflow in the pilot', metric: 'operationalEvidence', threshold: 40, direction: 'higher-is-better', kind: 'evidence' }], goThreshold: 1, conditionalThreshold: .5 }, deployment: { defaultMode: 'augmentation', modes: { augmentation: { efficiencyDelta: 7, riskDelta: -5, trustDelta: 4, oversightUnits: 2 }, automation: { efficiencyDelta: 16, riskDelta: 9, trustDelta: -3, oversightUnits: 3 } } }, risks: { model: 46, operational: 55, legal: 28 }, drift: { susceptibility: 42, quarterlyRate: 3, degradationThreshold: 55, monitoringRequired: true }, oversight: { baseUnits: 2, automationUnits: 3 }, autonomy: 'semi_autonomous', autonomyBoundaries: 'The model may recommend maintenance windows; plant engineering retains final work-order authority.', flywheel: { active: true, quality: 82, recipientIds: ['quality', 'energy'] } }, provisional: true },
