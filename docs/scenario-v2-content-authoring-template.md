# Scenario v2 Content-Authoring Template

Status: reusable draft template
Use this to author Project Factory v2 first, then every future v2 scenario pack. Complete each required field with scenario-specific content; do not place engine logic in the narrative sections.
