...
| UX-W1-08 | Open — context design required | Add a decision-context object and packet presentation for each opening priority: why now, known facts, unknowns, decision test, accountable role, if-deferred trigger, cost/capacity, and plain-language terms. Validate that a non-manufacturing reviewer can make a bounded Research choice from the pack alone. |
